...
from src.presentation.api.dependencies import get_create_order_use_case, get_orders_by_user_case
...
async def get_orders_by_user(
    user_id: UUID,
    use_case: GetOrdersByUserUseCase = Depends(get_orders_by_user_case),
):
